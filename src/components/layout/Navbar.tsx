'use client'
/**
 * DETAIL PALS V2 — Navbar (Phase 1 upgrade)
 * ===========================================
 * File: src/components/layout/Navbar.tsx
 *
 * Upgrades from Phase 0:
 * — React Router NavLink (active state via isActive)
 * — Active link gets persistent gold glow, not just hover
 * — Logo gets gold text-shadow glow
 * — Glass surface with refined saturation
 * — CTA button gains pulse animation when scrolled
 */
    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="w-full max-w-[var(--dp-max-w)] mx-auto flex items-center justify-between">
          ...
          {/* Desktop CTA */}
          <Link to="/booking" className="hidden lg:inline-flex group" aria-label="Book a detail">
            <span className={clsx(
        ...
        {open && (
          ...
          >
              ...
              >
                <NavLink
                  ...
                  className={({ isActive }) => clsx(
                    ...
                    'no-underline py-2 transition-colors duration-200',
            ...
            >
              <Link
                to="/booking"
                className="block font-sans font-normal text-[13px] tracking-[0.16em] uppercase text-dp-gold border border-[var(--dp-border-gold)] px-9 py-4 mt-2 hover:bg-dp-gold hover:text-dp-bg transition-colors duration-200 no-underline"
              >
                Book Now
              </Link>
            </m.div>
