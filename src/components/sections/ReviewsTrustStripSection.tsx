...
import { SectionInner, springs, fadeUp } from '@/design-system'
      ...
      <section className="bg-dp-bg py-8 border-t border-b border-dp-border/40 relative overflow-hidden">
        ...
        <SectionInner className="py-0">
          ...
          >
            ...
            <Link 
              to="/reviews" 
              className="flex items-center gap-4 group cursor-pointer no-underline focus:outline-none"
              data-cursor="hover"
            >
            ...
            <Link 
              to="/reviews" 
              className="font-sans font-normal text-xs tracking-wider uppercase text-dp-gold hover:text-dp-gold-light group flex items-center gap-2 transition-colors duration-300 no-underline"
              data-cursor="hover"
            >
              Read Client Stories
