...
export function ContactSection() {
  ...
  return (
    <Section id="contact" className="bg-dp-bg relative overflow-hidden border-t border-dp-border">
      <AtmosphericBackground variant="showroom" intensity={0.9} />

      <SectionInner className="relative z-10 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-start mt-4">
          ...
          <div className="lg:col-span-3">
            <div className="border border-dp-border bg-dp-surface/40 backdrop-blur-md p-8 md:p-10 rounded-none relative overflow-hidden">
              <AnimatePresence mode="wait">
                {!submitted ? (
                  ...
                  >
                    <div className="w-16 h-16 border border-dp-gold rounded-none flex items-center justify-center mx-auto mb-6 shadow-gold-sm">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Info Card */}
            <div className="border border-dp-border bg-dp-surface/40 backdrop-blur-md p-8 rounded-none">
            ...
            {/* Map Card */}
            <div className="relative w-full h-[240px] border border-dp-border">
              <iframe
              ...
              <a
                ...
                className="absolute top-3 left-3 bg-dp-surface-deep/90 border border-dp-border text-[9px] tracking-wider uppercase text-dp-text-muted hover:text-dp-gold px-2.5 py-1.5 rounded-none flex items-center gap-1.5 transition-colors no-underline backdrop-blur-sm shadow-sm"
                data-cursor="hover"
              >
